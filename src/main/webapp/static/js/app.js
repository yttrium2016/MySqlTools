...
var App = function () {
    ...
    var page, pageContent, header, sidebar, sBrand, sExtraInfo, sidebarAlt, sScroll, sScrollAlt, mainContent;
    ...
    var resizePageContent = function () {
        ...
        if (header.hasClass('navbar-fixed-top') || header.hasClass('navbar-fixed-bottom')) {
            ...
            //为什么是55 我也不知道 反正测出来的
            mainContent.css('min-height', windowH - 55);
            mainContent.css('height', windowH - 55);
        } else if (sidebarH > windowH) {
            pageContent.css('min-height', sidebarH - headerH);
            //为什么是55 我也不知道 反正测出来的
            mainContent.css('min-height', sidebarH - headerH - 55);
            mainContent.css('height', sidebarH - headerH - 55);
        } else {
            pageContent.css('min-height', windowH - headerH);
            //为什么是55 我也不知道 反正测出来的
            mainContent.css('min-height', windowH - headerH - 55);
            mainContent.css('height', windowH - headerH - 55);
        }
    };
